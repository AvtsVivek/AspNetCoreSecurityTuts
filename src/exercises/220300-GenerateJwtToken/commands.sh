...
cd ./../../dotnet-apps/220300-GenerateJwtToken/
...
dotnet build ./../../dotnet-apps/220300-GenerateJwtToken/GenerateJwtToken.csproj

dotnet run --project ./../../dotnet-apps/220300-GenerateJwtToken/GenerateJwtToken.csproj
