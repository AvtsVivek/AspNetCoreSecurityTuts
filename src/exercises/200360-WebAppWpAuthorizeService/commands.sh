...
dotnet build ./../../dotnet-apps/200360-WebAppWpAuthorizeService/WebAppWpAuthorizeService.csproj

dotnet run --project ./../../dotnet-apps/200360-WebAppWpAuthorizeService/WebAppWpAuthorizeService.csproj
...
cd src/dotnet-apps/200360-WebAppWpAuthorizeService
